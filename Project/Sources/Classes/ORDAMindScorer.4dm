...
Function _analyze($preprocessed : Object) : Object
	var $helper : cs.AIKit.OpenAIChatHelper
	...
	$helper:=This._client.chat.create("You are an expert evaluator. Return only valid JSON."; cs.AIKit.OpenAIChatCompletionsParameters.new($params))
