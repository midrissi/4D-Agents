...
Function handle($url : Text; $header : Text) : Boolean
	var $req:=cs:C1710.ORDAMindRequest.new($url)
	var $res:=cs:C1710.ORDAMindResponse.new()
...
Function _matchRoute($method : Text; $path : Text) : Object
	...
	// Route handlers
Function _listAgents($req : cs:C1710.ORDAMindRequest; $res : cs:C1710.ORDAMindResponse)
...
Function _getAgent($req : cs:C1710.ORDAMindRequest; $res : cs:C1710.ORDAMindResponse)
...
Function _agentGenerate($req : cs:C1710.ORDAMindRequest; $res : cs:C1710.ORDAMindResponse)
	var $agent:=This:C1470._mind.getAgent($req.params.agentId)
	If ($agent=Null:C1517)
		$res.status(404).json(New object:C1471("error"; "Agent not found"))
		return 
...
Function _agentStream($req : cs:C1710.ORDAMindRequest; $res : cs:C1710.ORDAMindResponse)
	$res.status(501).json(New object:C1471("error"; "Streaming not yet implemented"))
	
Function _listAgentTools($req : cs:C1710.ORDAMindRequest; $res : cs:C1710.ORDAMindResponse)
	var $agent:=This:C1470._mind.getAgent($req.params.agentId)
	If ($agent=Null:C1517)
		$res.status(404).json(New object:C1471("error"; "Agent not found"))
		return 
...
Function _executeAgentTool($req : cs:C1710.ORDAMindRequest; $res : cs:C1710.ORDAMindResponse)
	var $agent:=This:C1470._mind.getAgent($req.params.agentId)
	If ($agent=Null:C1517)
		$res.status(404).json(New object:C1471("error"; "Agent not found"))
		return 
	...
	For each ($tool; $agent.tools)
		If ($tool.id=$toolId) || ($tool.name=$toolId)
			var $input:=$req.body.input || $req.body || New object:C1471
			Try
...
Function _listWorkflows($req : cs:C1710.ORDAMindRequest; $res : cs:C1710.ORDAMindResponse)
	var $list : Collection:=New collection:C1472
	var $key : Text
	For each ($key; This:C1470._mind.workflows)
		var $wf:=This:C1470._mind.workflows[$key]
		$list.push(New object:C1471("id"; $wf.id; "name"; $wf.name))
	End for each 
	$res.json(New object:C1471("data"; $list))
	
Function _getWorkflow($req : cs:C1710.ORDAMindRequest; $res : cs:C1710.ORDAMindResponse)
...
Function _workflowCreateRun($req : cs:C1710.ORDAMindRequest; $res : cs:C1710.ORDAMindResponse)
	var $wf:=This:C1470._mind.getWorkflow($req.params.workflowId)
	If ($wf=Null:C1517)
		$res.status(404).json(New object:C1471("error"; "Workflow not found"))
		return 
...
Function _workflowStartAsync($req : cs:C1710.ORDAMindRequest; $res : cs:C1710.ORDAMindResponse)
	This:C1470._workflowCreateRun($req; $res)
	
Function _workflowStream($req : cs:C1710.ORDAMindRequest; $res : cs:C1710.ORDAMindResponse)
	$res.status(501).json(New object:C1471("error"; "Workflow stream not yet implemented"))
	
Function _workflowResume($req : cs:C1710.ORDAMindRequest; $res : cs:C1710.ORDAMindResponse)
	$res.status(501).json(New object:C1471("error"; "Workflow resume not yet implemented"))
	
Function _listWorkflowRuns($req : cs:C1710.ORDAMindRequest; $res : cs:C1710.ORDAMindResponse)
	$res.json(New object:C1471("data"; New collection:C1472))
	
Function _getWorkflowRun($req : cs:C1710.ORDAMindRequest; $res : cs:C1710.ORDAMindResponse)
	$res.status(404).json(New object:C1471("error"; "Run not found"))
	
Function _listTools($req : cs:C1710.ORDAMindRequest; $res : cs:C1710.ORDAMindResponse)
	var $list : Collection:=New collection:C1472
	var $key : Text
	For each ($key; This:C1470._mind.tools)
		var $tool:=This:C1470._mind.tools[$key]
		$list.push(New object:C1471("id"; $tool.id; "name"; $tool.name; "description"; $tool.description))
	End for each 
	$res.json(New object:C1471("data"; $list))
	
Function _getTool($req : cs:C1710.ORDAMindRequest; $res : cs:C1710.ORDAMindResponse)
...
Function _executeTool($req : cs:C1710.ORDAMindRequest; $res : cs:C1710.ORDAMindResponse)
	var $tool:=This:C1470._mind.getTool($req.params.toolId)
	If ($tool=Null:C1517)
		$res.status(404).json(New object:C1471("error"; "Tool not found"))
		return 
...
Function _listTraces($req : cs:C1710.ORDAMindRequest; $res : cs:C1710.ORDAMindResponse)
...
Function _getTrace($req : cs:C1710.ORDAMindRequest; $res : cs:C1710.ORDAMindResponse)
	If (This:C1470._mind.getStorage()=Null:C1517)
...
Function _getTraceSpans($req : cs:C1710.ORDAMindRequest; $res : cs:C1710.ORDAMindResponse)
	$res.json(New object:C1471("data"; New collection:C1472))
	
Function _listLogs($req : cs:C1710.ORDAMindRequest; $res : cs:C1710.ORDAMindResponse)
	$res.json(New object:C1471("data"; New collection:C1472))
	
Function _getLogsByRun($req : cs:C1710.ORDAMindRequest; $res : cs:C1710.ORDAMindResponse)
	$res.json(New object:C1471("data"; New collection:C1472))
	
Function _listScorers($req : cs:C1710.ORDAMindRequest; $res : cs:C1710.ORDAMindResponse)
	var $list : Collection:=New collection:C1472
	var $key : Text
	For each ($key; This:C1470._mind.scorers)
		var $scorer:=This:C1470._mind.scorers[$key]
		$list.push(New object:C1471("id"; $scorer.id; "name"; $scorer.name))
	End for each 
	$res.json(New object:C1471("data"; $list))
	
Function _getScorerScores($req : cs:C1710.ORDAMindRequest; $res : cs:C1710.ORDAMindResponse)
	$res.json(New object:C1471("data"; New collection:C1472))
	
Function _a2aRequest($req : cs:C1710.ORDAMindRequest; $res : cs:C1710.ORDAMindResponse)
	var $a2a:=cs:C1710.ORDAMindA2A.new(This:C1470._mind)
	var $body:=$req.body
	If ($body=Null:C1517)
...
Function _a2aCards($req : cs:C1710.ORDAMindRequest; $res : cs:C1710.ORDAMindResponse)
	var $a2a:=cs:C1710.ORDAMindA2A.new(This:C1470._mind)
